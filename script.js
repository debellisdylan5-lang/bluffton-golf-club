...
(function(){
  ...
  (async function loadLatestJournal(){
    if(!latestJournalGrid) return;
    try{
      const res = await fetch('https://blufftongc.com/blog', { credentials:'omit' });
